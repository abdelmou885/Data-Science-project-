...
# ==========================================
# 6. TRAIN MULTIPLE MODELS + COMPARE ACCURACY
# ==========================================
...
plt.ylabel("Accuracy")
plt.xlabel("Model")
plt.title("Accuracy Comparison: Decision Tree, Random Forest, Gradient Boosting, XGBoost")
plt.ylim(0, 1)
...
# ==========================================
# 11. DECISION TREE AND RANDOM FOREST MODELS
# ==========================================
...
print("[11] Decision Tree training complete.")
...
print("\n[12] Training Random Forest model...")
rf_pipeline.fit(X_train, y_train)
print("[12] Random Forest training complete.")
...
# ==========================================
# 12. SHOW DECISION TREE AND RANDOM FOREST PREDICTIONS
# ==========================================
...
predictions_df['Decision_Tree_Prediction'] = dt_pred
predictions_df['Decision_Tree_Probability_Error'] = dt_proba

predictions_df['Random_Forest_Prediction'] = rf_pred
predictions_df['Random_Forest_Probability_Error'] = rf_proba

# Convert 0/1 back to no/yes labels
predictions_df['Actual_Error_Label'] = predictions_df['Actual_Error'].map({0: 'no', 1: 'yes'})
predictions_df['Decision_Tree_Label'] = predictions_df['Decision_Tree_Prediction'].map({0: 'no', 1: 'yes'})
predictions_df['Random_Forest_Label'] = predictions_df['Random_Forest_Prediction'].map({0: 'no', 1: 'yes'})
...
print(predictions_df[
    [
        'Actual_Error_Label',
        'Decision_Tree_Label',
        'Decision_Tree_Probability_Error',
        'Random_Forest_Label',
        'Random_Forest_Probability_Error'
    ]
].head(30))
