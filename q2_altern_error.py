...
sns.heatmap(
    ...
    fmt='d',
    cmap='Blues',
    xticklabels=['Pred: no (OK)', 'Pred: yes (Faulty)'],
    yticklabels=['Actual: no (OK)', 'Actual: yes (Faulty)']
)
plt.title('Confusion Matrix - Logistic Regression')
plt.tight_layout()
plt.savefig('plot_04_confusion_matrix.png', dpi=150, bbox_inches='tight')
plt.close()
print("[8] Saved: plot_04_confusion_matrix.png")
...
plt.close()
print("[9] Saved: plot_05_feature_importance.png")
...
plt.savefig('plot_06_extended_comparison.png', dpi=150, bbox_inches='tight')
plt.close()
print("[10] Saved: plot_06_extended_comparison.png")
...
plt.grid(axis="y", alpha=0.3)
plt.tight_layout()
plt.savefig('plot_07_savings_logistic_regression.png', dpi=150, bbox_inches='tight')
plt.close()
print("[11] Saved: plot_07_savings_logistic_regression.png")